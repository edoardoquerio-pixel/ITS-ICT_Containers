...
Usa SQLite in-memory: engine globale condiviso, sessione dedicata
per test per garantire isolamento transazionale.
"""
import pytest
...
def client(test_db):
    ...
    Usa la stessa sessione di test_db per garantire che route e test
    vedano gli stessi dati all'interno dello stesso test.
    """
